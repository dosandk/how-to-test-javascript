...
describe('RangePicker', () => {
  ...
  it("should show selected dates 'dateFrom-dateTo' in input", () => {
    ...
    expect(dateFrom).toMatch('10/2/19');
    expect(dateTo).toMatch('11/5/19');
  });
  ...
  it('should show correct initial months in calendar', () => {
    ...
    expect(first.textContent.trim()).toEqual('October');
    expect(second.textContent.trim()).toEqual('November');
  });
  ...
  it('should have ability to switch to the next couple of months', () => {
    ...
    const rightNavigation = rangePicker.element.querySelector(
    ...
    expect(first.textContent.trim()).toEqual('November');
    expect(second.textContent.trim()).toEqual('December');
  });
  ...
  it('should have ability to switch to the previous couple of months', () => {
    ...
    expect(first.textContent.trim()).toEqual('September');
    expect(second.textContent.trim()).toEqual('October');
  });
  ...
  it('should have ability to select dates range bigger than two months', () => {
    ...
    expect(dateFrom).toMatch('10/1/19');
    expect(dateTo).toMatch('12/31/19');
  });
